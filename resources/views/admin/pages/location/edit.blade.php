                        ...
                        <div class="card-body row">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    <input type="text" class="form-control form-control-user" name="name"
                                        placeholder="Location Name" value="{{ old('name') ? old('name') : $name }}" required>
                                    <input type="hidden" value="{{ csrf_token() }}" name="_token" />
                                    <input type="hidden" value="{{ old('id') ? old('id') : $id }}" name="id" />
                                </div>
                                ...
                                <div class="input-group col-12">
                                    <textarea class="form-control" name="address" aria-label="With textarea" placeholder="Location Address">{{ old('address') ? old('address') : $address }}</textarea>
                                </div>
                        </div>
