                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body row">
                                ...
                                <div class="input-group col-12 col-md-6 mb-3">
                                    ...
                                    <input type="number" min="10000" class="form-control" placeholder="150000" aria-describedby="basic-addon2" name="price" value="{{ old('price') }}" required>
                                ...
                                <div class="input-group col-12 col-md-6 mb-3">
                                    ...
                                    <input type="number" min="1" class="form-control" placeholder="2" aria-describedby="basic-addon2" name="credit" value="{{ old('credit') }}" required>
                                ...
                                <div class="input-group col-12 mb-3">
                                    <textarea class="form-control" name="description" aria-label="With textarea" placeholder="Description">{{ old('description') }}</textarea>
                                </div>
                        </div>
